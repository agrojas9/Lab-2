...
const footballClubSchema = new mongoose.Schema({
    ...
    school: { type: String, required: true }, // a require string
    mascot: { type: String, required: true }, // a require string
    color: { type: String, required: true }, // a require string
    conference: { type: String, required: true }, // a require string
    search: [String], // an array of strings
});
